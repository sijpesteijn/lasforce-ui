...
import { AppState, InternalStateType, AppEventService } from './app.service';
...
if ('production' === ENV) {
    ...
    enableProdMode();
    PROVIDERS = [
        { provide: 'settings.path', useValue: '/assets/config/application.json' },
    ];
} else {
    PROVIDERS = [
