...
var UploadAnimationControl = (function () {
    function UploadAnimationControl(animationService) {
        this.animationService = animationService;
    }
    UploadAnimationControl.prototype.newAnimation = function () {
    ...
    return UploadAnimationControl;
}());
UploadAnimationControl = __decorate([
    core_1.Component({
        selector: 'upload-animation',
        template: require('./upload-animation-control.html')
    })
], UploadAnimationControl);
exports.UploadAnimationControl = UploadAnimationControl;
